...
from src.nikhil.niti.domain.planning_capacity.model.sprint_plan import SprintPlan


class PlanningCapacityApplication(AmshaCrewFileApplication):
    ...
    def run(self) -> Any:
        ...
        for crew_name in pipeline_steps:
            if not pipeline_results:
                ...
                # CREW-03 input
                pipeline_input["consensus_report"] = next_input["consensus_report"]
...
if __name__ == "__main__":
    ...
    configs = {
        ...
        "job": "/home/user/Arsha/Niti/src/nikhil/niti/domain/planning_capacity/config/planning_capacity_config.yaml"
    }

    app = PlanningCapacityApplication(
